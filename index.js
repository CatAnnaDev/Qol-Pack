...
//Command
  command.add('qp', {
    ...
    'spam': () => {
      mod.settings.spam = !mod.settings.spam
      sendMessage("Spam-Remover: " + (mod.settings.Spam ? "On" : "Off"));
    },
    'UI': () => {
      ui.show();
    },
